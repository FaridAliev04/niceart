...
const Email = () => {
    return (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M18.3332 5.94958V14.2829C18.3332 14.8355 18.1137 15.3654 17.723 15.7561C17.3323 16.1468 16.8024 16.3663 16.2498 16.3663H3.74984C3.1973 16.3663 2.6674 16.1468 2.2767 15.7561C1.886 15.3654 1.6665 14.8355 1.6665 14.2829V5.94958" stroke="#170F49" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/>
